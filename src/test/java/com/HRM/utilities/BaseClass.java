...

{
	...
	public void setup(String br)
	{
		try {			
			if(br.equalsIgnoreCase("chrome"))
			{
				...
				reporterOnStart(); // start reporter
				System.setProperty("webdriver.chrome.driver",pro.getChromeDriverPath());
				//WebDriverManager.chromedriver().setup(); //Driver setup with WebDriverManager
			...
			else if(br.equalsIgnoreCase("fireFox"))
			{
				...
				//WebDriverManager.firefoxdriver().setup(); //Driver setup with WebDriverManager
	...
	public void customLogger(Status status,String message)
	{	
		if (status.equals(Status.PASS))
		{
		logger.log(status,MarkupHelper.createLabel(message,ExtentColor.GREEN));
		}
		else if (status.equals(Status.FAIL))
			
		{
		logger.log(status,MarkupHelper.createLabel(message,ExtentColor.RED));
		}
		else if(status.equals(Status.INFO))
		{
			logger.log(status,MarkupHelper.createLabel(message,ExtentColor.WHITE));
		}
	}
